    ...
    <>
      ...
      <div className='flex h-full w-full gap-10 flex-wrap justify-center'>
...

        {
          productNames.map((_, i) => (
            <div key={i}  className={`flex flex-wrap h-full justify-center items-center`}>
              <Gallery aboutFlower={aboutFlower[i]} productName={productNames[i]} styles={styles.bg[i]} />
            </div>
          )
        )
      };
        ...
        {/* <div className={`flex flex-wrap h-full justify-center items-center`}>
              <Gallery aboutFlower={aboutFlower[0]} productName={productNames[0]} styles={styles.bg[0]} />
            </div>

            <div className={`flex flex-wrap h-full justify-center items-center`}>
              <Gallery aboutFlower={aboutFlower[1]} productName={productNames[1]} styles={styles.bg[1]} />
            </div>

            <div className={`flex flex-wrap h-full justify-center items-center`}>
              <Gallery aboutFlower={aboutFlower[2]} productName={productNames[2]} styles={styles.bg[2]} />
            </div> */}
